        ...
        <div className={`fixed w-full top-0 flex justify-between gap-16 items-center px-4 md:px-16 py-2 md:py-4 z-50 ${scrolling ? 'backdrop-blur-md' : ''}`}>
            ...
            <div className="flex items-center md:gap-2">
                ...
                <div className="relative ml-3 w-max" id="user-menu-section">
                    ...
                    <div ref={modalRef} hidden={!openProfileDropdown} className="absolute right-0 z-10 w-48 py-1 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-700 dark:border-1 dark:outline-slate-50" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button">
